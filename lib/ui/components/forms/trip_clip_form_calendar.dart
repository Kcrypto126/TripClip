...
class _TripClipFormCalendarState extends State<TripClipFormCalendar> {
  ...
  DateTime? get _shownSelected => widget.selectedDate != null
      ? _dateOnly(widget.selectedDate!)
      : _localSelected;

  bool get _isLight => Theme.of(context).brightness == Brightness.light;

  Color get _calendarAccentColor => context.tripClipColors.heading;
  ...
  Color get _primaryTextColor => context.tripClipColors.textBase;
  ...
  List<_CalendarDayCell> _buildCells() {
    ...
    for (var d = 1; d <= daysInMonth; d++) {
      cells.add(
        _CalendarDayCell(date: DateTime(y, m, d), inFocusedMonth: true),
      );
    }
    var nextAdjacent = 1;
          ...
          children: [
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final textMax = (titleBlockMax - 4 - 24).clamp(
                  0.0,
                  double.infinity,
                );
                return Row(
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final cellW = (w - 6 * _kFormCalendarCellGap) / 7;
                  ...
                  children: [
                    Row(
                      children: [
                        for (var c = 0; c < 7; c++) ...[
                          if (c > 0)
                            const SizedBox(width: _kFormCalendarCellGap),
                          SizedBox(
                            width: cellW,
                        ...
                        children: [
                          for (var c = 0; c < 7; c++) ...[
                            ...
                            _DateCell(
                              ...
                              inMonthColor: _primaryTextColor,
