...
class TripClipParcelsCreateDeliveryPage extends StatefulWidget {
  const TripClipParcelsCreateDeliveryPage({super.key});

  static const int totalSteps = 7;

  @override
  State<TripClipParcelsCreateDeliveryPage> createState() =>
      _TripClipParcelsCreateDeliveryPageState();
}

class _TripClipParcelsCreateDeliveryPageState
    extends State<TripClipParcelsCreateDeliveryPage> {
  static const int _stepIndex = 2;
  ...
  ParcelsAddressKind _addressKind = ParcelsAddressKind.business;
  ...
  DateTimeRange? _deliveryDateRange;
  TripClipTimeRange? _deliveryTimeRange;
  ...
  void didChangeDependencies() {
    ...
    setState(() {
      ...
      _deliveryDateRange = p.dateRange;
      _deliveryTimeRange = p.timeRange;
    });
  }
  ...
  ParcelsAddressDraft _buildDeliveryDraft() {
  ...
  Future<void> _openDeliveryDateRangeSheet() async {
    final r = await showTripClipPickupDateRangeSheet(
      context,
      initialRange: _deliveryDateRange,
      title: 'Delivery Date Range',
    );
    if (r == null || !mounted) return;
    setState(() {
      _deliveryDateRange = r;
      _dateSelection = _kIndexDateRange;
    });
  }

  Future<void> _openDeliveryTimeRangeSheet() async {
    final r = await showTripClipPickupTimeRangeSheet(
      context,
      initialRange: _deliveryTimeRange,
    );
    if (r == null || !mounted) return;
    setState(() {
      _deliveryTimeRange = r;
  ...
  void _goNext() {
    ...
    TripClipParcelsCreateScope.of(context).setDelivery(_buildDeliveryDraft());
    if (_returnToSummary) {
  ...
  String _formatDeliveryDateRange(DateTimeRange r) {
    final a = r.start;
    final b = r.end;
  ...
  String _formatDeliveryTimeRange(TripClipTimeRange r) {
  ...
  Widget build(BuildContext context) {
    ...
    return TripClipSteppedTitlePageScaffold(
      ...
      totalSteps: TripClipParcelsCreateDeliveryPage.totalSteps,
      title: 'Delivery',
      onStepChanged: (next) {
        if (next < _stepIndex) {
      ...
      body: Column(
        ...
        children: [
          ...
          TripClipFormTextarea(
            ...
            hintText: 'Enter details about the delivery address',
            fieldHeight: 112,
            minLines: 1,
            maxLength: 600,
          ),
          ...
          _dateTimeOptionGrid(
            ...
            onChanged: (i) {
              ...
              if (i == _kIndexDateRange) {
                _openDeliveryDateRangeSheet();
              }
            },
          ),
          if (_dateSelection == _kIndexDateRange && _deliveryDateRange != null) ...[
            const SizedBox(height: 8),
            Text(
              _formatDeliveryDateRange(_deliveryDateRange!),
              style: helperStyle,
            ),
          ],
          const SizedBox(height: 40),
          ...
          _dateTimeOptionGrid(
            ...
            onChanged: (i) {
              ...
              if (i == _kIndexTimeRange) {
                _openDeliveryTimeRangeSheet();
              } else {
                _deliveryTimeRange = null;
              }
            },
          ),
          if (_timeSelection == _kIndexTimeRange && _deliveryTimeRange != null) ...[
            const SizedBox(height: 8),
            Text(
              _formatDeliveryTimeRange(_deliveryTimeRange!),
              style: helperStyle,
            ),
          ],
        ],
      ...
      bottomBar: SafeArea(
        ...
        child: Padding(
          ...
          child: TripClipButton(
            ...
            expanded: true,
            label: _returnToSummary ? 'Summary' : 'Recipient Details',
