...
import '../../../auth/presentation/trip_clip_mobile_display_format.dart';

class TripClipAccountVerifyMobileOtpPage extends StatefulWidget {
  const TripClipAccountVerifyMobileOtpPage({
    super.key,
  ...
  @override
  State<TripClipAccountVerifyMobileOtpPage> createState() =>
      _TripClipAccountVerifyMobileOtpPageState();
}

class _TripClipAccountVerifyMobileOtpPageState
    extends State<TripClipAccountVerifyMobileOtpPage> {
